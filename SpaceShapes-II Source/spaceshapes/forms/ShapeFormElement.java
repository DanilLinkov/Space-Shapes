...
public class ShapeFormElement extends FormElementComponent {
	...
	public ShapeFormElement() {
		...
		addField(WIDTH, DEFAULT_WIDTH, Integer.class);
		addField(HEIGHT, DEFAULT_HEIGHT, Integer.class);
		addField(DELTA_X, DEFAULT_DELTA_X, Integer.class);
		addField(DELTA_Y, DEFAULT_DELTA_Y, Integer.class);
		addField(TEXT, DEFAULT_TEXT, String.class);
