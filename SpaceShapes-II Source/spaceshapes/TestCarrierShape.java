...
public class TestCarrierShape {
	...
	public void testBasicMovementAndPainting() {
		...
		assertEquals("(rectangle 2,2,100,100)(rectangle 2,2,50,50)(rectangle 7,7,10,10)" +
				"Querying old color RGB: [212:212:212]" +
				"Set color to RGB: [212:212:212]" +
				"(rectangle 2,2,5,5)" +
				"Set color to RGB: [212:212:212]", painter.toString());
	}
	...
	public void testShapeWithTextPrinting() {
		Painter painter = new MockPainter();
		CarrierShape shape = new CarrierShape(100, 20, 12, 15,30,30);
		shape.addText("test");
		shape.doPaint(painter);
		assertEquals("Drawing text: test at x:115 y:35(rectangle 100,20,30,30)",
				painter.toString());
	}
	...
	public void testShapeWithTextMoving() {
		...
		shape.move(300,300);
		shape.doPaint(painter);
		assertEquals("Drawing text: test at x:115 y:35(rectangle 100,20,30,30)Drawing text: test at x:127 y:50(rectangle 112,35,30,30)",
				painter.toString());
	}
